...
public class PhongSingle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frmphong_single);
        ...
        second_back_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PhongSingle.this, Phong.class);
        ...
        second_arrow_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(PhongSingle.this, pairs);
