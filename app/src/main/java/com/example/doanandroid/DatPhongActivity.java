...
//            String mainfile="";
//            try {
//                URL url = new URL("https://api.npoint.io/52bc51e1843e8ec60262");
...
//                        String id = hotelObj.getString("IDTAIKHOAN");
//                        String email = hotelObj.getString("EMAIL");
//                        String phone = hotelObj.getString("DIENTHOAI");
//                        String addr = hotelObj.getString("DIACHI");
//                        String sex = hotelObj.getString("GIOITINH");
//                        if(emailPut==email){
//                            main = new User(id, ten, email, phone, addr, sex);
//                            name1 =ten;
//                            email1 = email;
//                            phone1 = phone;
//                            addr1 = addr;
...
//            hotel = findViewById(R.id.ednamehotel);
//            quantity = findViewById(R.id.edSoluong);
//            ngaydat = findViewById(R.id.edNgayDat);
//            ngaynhan = findViewById(R.id.edNgaynhan);
//
//            name.setText(main.getName());
//            email.setText(main.getEmail());
//            phone.setText(main.getPhoneNum());
//            address.setText(main.getAddress());
//            hotel.setText(hotels.getTenks());
//        }
//    }
}